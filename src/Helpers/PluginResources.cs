namespace Loupedeck.VolumeControlPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.VolumeControlPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.VolumeControlPlugin.Resources.Resource.txt`.
